\chapter*{Udbredte racer i Kalish}\addcontentsline{toc}{chapter}{Udbredte racer i Kalish}
...
\section*{Menneske}\addcontentsline{toc}{section}{Menneske}
...
\section*{Dværge}\addcontentsline{toc}{section}{Dværge}
\begin{race*}[Dværge]
\textbf{LP:} 3\\ 
\textbf{NK:} 4\\ 
...
\newpage
\section*{Halvlang}\addcontentsline{toc}{section}{Halvlang}
...
\section*{Elver}\addcontentsline{toc}{section}{Elver}
\begin{race*}[Elvere]
\textbf{LP:} 3\\ 
\textbf{NK:} 2\\ 
...
\section*{Grønhuder}\addcontentsline{toc}{section}{Grønhuder}
