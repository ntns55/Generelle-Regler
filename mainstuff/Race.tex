...
\rule{\textwidth}{0.4pt}
\textbf{Bære person:} \input{../Evne-Ordbog/GenerelleEvner/Evner/Bære PersonDesc.tex}
\end{race*}
...
\textit{Imperiet har hovedsæde i Nordland. Imperiet er det kejserige, som næsten alle mennesker er en del af. Her lever mennesker under stor disciplin fra Kejserinden og hendes veltrænede legionærhær, eller som robuste øksesvingende Nordlinge fra gletscheren.}\\
\textbf{Evner:} Mennesker fra Nordland har evnerne Bong og Førstehjælp.\\
\textbf{Bonk:} \input{../Evne-Ordbog/GenerelleEvner/Evner/BonkDesc.tex}\\
\textbf{Førstehjælp:} \input{../Evne-Ordbog/GenerelleEvner/Evner/FrøstehjælpDesc.tex}\\
...
\textbf{Evne:} Mennesker fra Sydland får +5 Fjend ved hver spilgang.\\
...
\rule{\textwidth}{0.4pt}
\textbf{Minearbejder:} \input{../Evne-Ordbog/GenerelleEvner/Evner/MinearbejderDesc.tex}
\end{race*}
...
\textbf{Reparere rustning Niv. 1:} \input{../Evne-Ordbog/Reparere rustning Niv. 1Desc.tex}
\textbf{Lave låse Niv. 1:} \input{../Evne-Ordbog/Lave Låse Niv. 1Desc.tex}
...
\textbf{LP:} 2\\ 
\textbf{NK:} 1\\ 
\textbf{Evne:} Bonk, 6. sans \& Lommetyveri Niv. 1\\
\textbf{Krav:} Makshøjde: 170 cm. Ingen kostumekrav.\\
\rule{\textwidth}{0.4pt}
\textbf{Bonk:} \input{../Evne-Ordbog/GenerelleEvner/Evner/BonkDesc.tex}
\textbf{6. Sans:} \input{../Evne-Ordbog/GenerelleEvner/Evner/6SansNiv1Desc.tex}
\textbf{Lommetyveri Niv. 1:} \input{../Evne-Ordbog/Lommetyveri/Lommetyveri Niv. 1Desc.tex}
\end{race*}
...
\rule{\textwidth}{0.4pt}
\textbf{Læse og skrive Elvisk:} \input{../Evne-Ordbog/Læse og skrive/Læse og skrive ElviskDesc.tex}
\end{race*}
...
\textbf{Påfør gift:} \input{../Evne-Ordbog/GenerelleEvner/Evner/Påfør GiftDesc.tex}
...
\textbf{Krav:} Som sortelver skal du males sort/grå på alle synlige steder.\\
\textbf{Evne:} Du får evnen Påfør gift og Rygte Spreder/Samler Niv. 1\\
\textbf{Påfør gift:} \input{../Evne-Ordbog/GenerelleEvner/Evner/Påfør GiftDesc.tex}
\textbf{Rygte Spreder/Samler Niv. 1:} \input{../Evne-Ordbog/Rygtespreder/Rygtespreder Niv 1Desc.tex}
...
\rule{\textwidth}{0.4pt}\\
\textbf{Krigsleder:} Når en goblin ser en blodork vil goblinens kampgejst blive forøget. Gobliner som kan se en blodork vil få 1 Midlertidig LP og + 1 NK. LP’et er det første der mistes i kamp og kan ikke genvindes før næste slag.\\
\textbf{Vigtigt!} En goblin kan kun få denne effekt af en blodork. Hvis orkhæren har 3 blodorker vil goblinerne i hæren kun modtage 1 Midlertidig LP og ikke 3.\\
\end{race*}
